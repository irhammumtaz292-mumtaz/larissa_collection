    ...
    <section id="katalog" class="page-section bg-light py-5">
        <div class="container">
            ...
            <?php if (count($data_produk) > 6) : ?>
                ...
                <div id="catalogCarousel" class="carousel slide" data-bs-wrap="false" data-bs-interval="false" data-bs-touch="false" data-bs-keyboard="false">
    ...
    <section class="page-section" id="about">
        <div class="container">
            ...
            <ul class="timeline">
                ...
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="../../assets/img/mitra/mitra.jpeg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>2026</h4>
